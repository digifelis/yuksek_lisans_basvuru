 ...
 <div class="box-content row">
         ...
         <td>
                    ...
                    <label >Doğum Tarihi</label><br>
                        ...
                        <select class="form-control" style="width:80px; display:inline;"  name="gun" >
      ...
      <option <?php if($satir->d_gun == 31) { echo "selected"; } else {echo "";}   ?> value="31">31</option>
                        ...
                        <select  class="form-control" style="width:80px; display:inline;"  name="ay" >
        ...
        <option <?php if($satir->d_ay == 12) { echo "selected"; } else {echo "";}   ?> value="12">12</option>
                        ...
                        <select  class="form-control" style="width:90px; display:inline;"  name="yil" >
...
<br />
                        ...
                        <select class="form-control" style="width:120px;"  name="cinsiyet" >
...
<br />
               ...
               <option <?php if($satir->askerlik == 0) { echo "selected"; } else {echo "";}   ?> value="0" selected="">Yapıldı</option>
        <option <?php if($satir->askerlik == 1) { echo "selected"; } else {echo "";}   ?> value="1">Yapılmadı</option>
        <option <?php if($satir->askerlik == 2) { echo "selected"; } else {echo "";}   ?> value="2">Muaf</option>
	<option <?php if($satir->askerlik == 3) { echo "selected"; } else {echo "";}   ?> value="3">Tecilli</option>
                ...
                <br>
                  Doğum Yeri&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="text" class="form-control" name="dogum_yeri" value="<?php echo $satir->dogum_yeri; ?>">
               
                <br>
                
              Adı&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="text" class="form-control"  name="adi"  value="<?php echo $satir->adi;?>">
               
                 <br>
                Soyadı&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="text" class="form-control"  name="soyadi"  value="<?php echo $satir->soyadi;?>">
