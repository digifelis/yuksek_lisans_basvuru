...
if($_POST) {
	...
	$db->query("insert into ilanlar (ilan_adi,bas_tarihi,bit_tarihi,ales_turu,aktif,enstitu,ana_bilim,bilim_dali) values ('".$ilan_adi."','".$bas_tarihi."','".$bit_tarihi."','".$ales_turu."','".$aktif."' , '".$enstitu."' , '".$ana_bilim."' , '".$bilim_dali."') ");
