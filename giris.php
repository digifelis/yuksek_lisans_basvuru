...
<div class="ch-container">
    ...
    <div class="row">
		...
		<center><a href="http://basvuru.siirt.edu.tr/formasyon/index.php/285927"><h2><strong>Formasyon Başvurusu İçin Tıklayınız.</strong></h2></a></center>
        <!--/span-->
    </div><!--/row-->
	...
	if($uyari == "") {
		echo '<div class="alert alert-success">
                ...
                T.C. Kimlik ve Parolanız İle Giriş Yapınız.
      </div>';
	}
	?>
    <?php 
	if($uyari == 1) {
		echo '<div class="alert alert-success">
		<strong>Kayıt İşlemi Başarılı<br>
                T.C. Kimlik ve Parolanız İle Giriş Yapınız.</strong>
      </div>';
	}
	?>
	...
	if($uyari == 2) {
		...
		Bu T.C. Kimliği Zaten Kayıtlı<br>
                T.C. Kimlik ve Parolanız İle Giriş Yapınız.
      </div>';
	}
	?>
           ...
           <a href="kayip_sifre.php"> Şifremi Unuttum.</a>
