...
<div class="ch-container">
	...
	if($_GET[uyari] == "") {
		echo '<div class="alert alert-success">
                ...
                T.C. Kimlik ve Email Bilginizi Giriniz.
      </div>';
	}
	?>
    <?php 
	if($_GET[uyari] == 1) {
		...
		Email Adresinize Gerekli Bilgiler Yollandı.<br>
                Gönderdiğimiz Email Spam Klasörüne Düşmüş Olabilir.
      </div>';
	}
	?>
	...
	if($_GET[uyari] == 2) {
		...
		Email Yada T.C. Kimlik No Hatalı<br>
              Lütfen Kontrol Ediniz.
      </div>';
	}
	?>
           
            <form class="form-horizontal" action="kayip_kontrol.php" method="post">
                <fieldset>
                   ...
                   <!-- <div class="input-prepend">
                    ...
                    <p class="center col-md-5">
                        <button type="submit" class="btn btn-primary">Şifremi Gönder</button>
                    </p>
                </fieldset>
            </form>
