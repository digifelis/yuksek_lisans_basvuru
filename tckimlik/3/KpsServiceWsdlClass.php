<?php
/**
 * File for KpsServiceWsdlClass to communicate with SOAP service
 * @package KpsService
 ...
 */
/**
 * KpsServiceWsdlClass to communicate with SOAP service
 * 
 * @package KpsService
 * @author WsdlToPhp Team <contact@wsdltophp.com>
 * @version 20150429-01
 * @date 2015-06-16
 */
class KpsServiceWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'https://kpsbasvuru.nvi.gov.tr/Services/WsdlNoPolicy.ashx?Service=KisiSorgulaTCKimlikNoServis&TestMode=true';
    /**
    ...
    /**
     * Constructor
     * @uses KpsServiceWsdlClass::setLastError()
     * @uses KpsServiceWsdlClass::initSoapClient()
     * @uses KpsServiceWsdlClass::initInternArrayToIterate()
     * @uses KpsServiceWsdlClass::_set()
     ...
     * @return KpsServiceWsdlClass|null
     */
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'KpsServiceWsdlClass'))
            {
     ...
     * @uses KpsServiceClassMap::classMap()
     * @uses KpsServiceWsdlClass::getDefaultWsdlOptions()
     * @uses KpsServiceWsdlClass::getSoapClientClassName()
     * @uses KpsServiceWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('KpsServiceClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = KpsServiceClassMap::classMap();
     ...
     * If a class is named as {KpsService}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('KpsServiceSoapClient') && is_subclass_of('KpsServiceSoapClient','SoapClient'))
            return 'KpsServiceSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses KpsServiceWsdlClass::WSDL_CACHE_WSDL
     * @uses KpsServiceWsdlClass::WSDL_COMPRESSION
     * @uses KpsServiceWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses KpsServiceWsdlClass::WSDL_ENCODING
     * @uses KpsServiceWsdlClass::WSDL_EXCEPTIONS
     * @uses KpsServiceWsdlClass::WSDL_FEATURES
     * @uses KpsServiceWsdlClass::WSDL_LOGIN
     * @uses KpsServiceWsdlClass::WSDL_PASSWORD
     * @uses KpsServiceWsdlClass::WSDL_SOAP_VERSION
     * @uses KpsServiceWsdlClass::WSDL_STREAM_CONTEXT
     * @uses KpsServiceWsdlClass::WSDL_TRACE
     * @uses KpsServiceWsdlClass::WSDL_TYPEMAP
     * @uses KpsServiceWsdlClass::WSDL_URL
     * @uses KpsServiceWsdlClass::VALUE_WSDL_URL
     * @uses KpsServiceWsdlClass::WSDL_USER_AGENT
     * @uses KpsServiceWsdlClass::WSDL_PROXY_HOST
     * @uses KpsServiceWsdlClass::WSDL_PROXY_PORT
     * @uses KpsServiceWsdlClass::WSDL_PROXY_LOGIN
     * @uses KpsServiceWsdlClass::WSDL_PROXY_PASSWORD
     * @uses KpsServiceWsdlClass::WSDL_LOCAL_CERT
     * @uses KpsServiceWsdlClass::WSDL_PASSPHRASE
     * @uses KpsServiceWsdlClass::WSDL_AUTHENTICATION
     * @uses KpsServiceWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses KpsServiceWsdlClass::getSoapClient()
     * @uses KpsServiceWsdlClass::getFormatedXml()
     ...
     * @uses KpsServiceWsdlClass::getSoapClient()
     * @uses KpsServiceWsdlClass::convertStringHeadersToArray()
     ...
     * @uses KpsServiceWsdlClass::count()
     * @return int
     */
     ...
     * @uses KpsServiceWsdlClass::getInternArrayToIterate()
     * @uses KpsServiceWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses KpsServiceWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses KpsServiceWsdlClass::getInternArrayToIterateOffset()
     * @uses KpsServiceWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses KpsServiceWsdlClass::getInternArrayToIterateOffset()
     * @uses KpsServiceWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see KpsServiceWsdlClass::offsetGet()
     * @uses KpsServiceWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses KpsServiceWsdlClass::getAttributeName()
     * @uses KpsServiceWsdlClass::__toString()
     * @uses KpsServiceWsdlClass::_set()
     * @uses KpsServiceWsdlClass::_get()
     * @uses KpsServiceWsdlClass::setInternArrayToIterate()
     * @uses KpsServiceWsdlClass::setInternArrayToIterateIsArray()
     * @uses KpsServiceWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses KpsServiceWsdlClass::item()
     * @uses KpsServiceWsdlClass::length()
     * @return mixed
     */
